...
const scandQRCODEText = ref("-------------------------------------");

function onResult(data: Result | undefined): void {
    decode.value = data
    if (data)
        scandQRCODEText.value = data.text;
    console.log(data);
}
            ...
            <div class="absolute top-0 h-[100%] w-full bg-neutral-150 ">
                <div class="flex flex-col w-full h-[100%]  text-white px-4 py-3 gap-2">
                    ...
                    <div class="flex-1 z-0 w-[100%] overflow-auto">
                        ...
                        <Input v-model="scandQRCODEText" />
                        <StreamQrcodeBarcodeReader capture="shoot" @onloading="onLoading" @result="onResult"
                            class="w-[90%] h-[90%] rounded-2xl">
                        ...
                        <div class="flex gap-2 ml-auto">
                            ...
                            <TooltipProvider>
                                <TooltipRoot>
                                    <TooltipTrigger
                                        ...
                                        <Link class=" bg-gray-900 text-blue-200 hover:bg-gray-800"
                            ...
                            <TooltipProvider>
                                <TooltipRoot>
                                    <TooltipTrigger
                                        class="text-grass11 shadow-blackA7 hover:bg-green3 inline-flex h-[35px] w-[35px] items-center justify-center rounded-lg bg-slate-900 shadow-[0_2px_10px] outline-none focus:shadow-[0_0_0_2px] focus:shadow-black">
                                        <Link class="z-1000 bg-gray-900 text-blue-200 hover:bg-gray-800"
                                            :href="qrcode.create().url">
                                            <UtilityPole />
                                        </Link>
